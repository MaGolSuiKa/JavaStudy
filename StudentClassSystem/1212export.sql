...
CREATE TABLE `attendance` (
  ...
  `att_date` date DEFAULT NULL COMMENT '日期时间',
  `homework` int(3) DEFAULT NULL COMMENT '作业情况，“1”完成，“0”未完成',
  `comment` varchar(45) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`attendance_id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COMMENT='出勤表';
...
INSERT INTO `attendance` VALUES (1,1,1,1,'2023-06-10',1,NULL),(2,1,2,1,'2023-06-10',1,NULL),(3,1,3,1,'2023-06-10',1,NULL),(4,1,4,1,'2023-06-10',0,NULL),(5,1,5,0,'2023-06-10',1,NULL),(6,1,1,1,'2023-06-12',1,NULL),(7,1,2,1,'2023-06-12',1,NULL),(8,1,3,1,'2023-06-12',1,NULL),(9,1,4,1,'2023-06-12',1,NULL),(10,1,5,1,'2023-06-12',1,NULL),(11,1,1,0,'2023-06-14',1,NULL),(12,1,2,0,'2023-06-14',1,NULL),(13,1,3,1,'2023-06-14',0,NULL),(14,1,4,1,'2023-06-14',1,NULL),(15,1,5,1,'2023-06-14',1,NULL),(16,1,1,1,'2023-06-16',1,NULL),(17,1,2,1,'2023-06-16',1,NULL),(18,1,3,0,'2023-06-16',0,NULL),(19,1,4,2,'2023-06-16',1,NULL),(20,1,5,2,'2023-06-16',1,NULL);
...
CREATE TABLE `student` (
  ...
  `stu_start_date` date DEFAULT NULL COMMENT '入学时间',
  `stu_comment` varchar(45) DEFAULT 'null' COMMENT '备注',
  PRIMARY KEY (`stu_id`)
...
INSERT INTO `student` VALUES (1,'赵','2023-01-01','null'),(2,'钱','2023-01-02','null'),(3,'孙','2023-01-01','null'),(4,'李','2023-01-03','null'),(5,'周','2023-01-01','null'),(6,'吴','2023-01-05','null'),(7,'郑','2023-01-04','null'),(8,'王','2023-01-09','null'),(9,'冯','2023-01-07','null'),(10,'陈','2023-01-01','null');
...
-- Dump completed on 2023-12-12 15:52:28
